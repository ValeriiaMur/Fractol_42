...
/*   Updated: 2018/12/05 19:06:24 by vmuradia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	julia(t_data *data)
{
	...
	for (int y = 100; y < data->height; y++)
	{
		...
		{
			data->newRe = 1.5 * (x - data->width / 2) / (0.3 * data->width) + data->moveX;
  			data->newIm = (y - data->height / 2) / (0.3 * data->height) + data->moveY;
